    ...
    <div>
      <nav className='bg-[#2f2626] text-white items-center flex gap-5 p-2 justify-between'>
        ...
        <div className='flex gap-5 items-center text-xl justify-around px-10'>
          ...
          <NavLink  className={({isActive})=>isActive? " text-orange-600":"" } to={"products"}>products</NavLink>
          <NavLink  className={({isActive})=>isActive? " text-orange-600":"" } to={"contact"}>contact us</NavLink>
        </div>
      </nav>
    </div>
  )
